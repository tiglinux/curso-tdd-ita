...
public class Armazenamento {
	...
	public void registerPoint(String user, String type, int value) {
	...
	public String returnPoint(String usuario) {
	...
	public String returnPointPerType(String usuario, String tipo) {
		String saida = "";
		int total = 0;
	...
	public HashMap<String, Integer> returnRank(String tipoPonto) {
		HashMap<String, Integer> mapa = new HashMap<>();
		mapa = (HashMap<String, Integer>) returnMapRank(tipoPonto);

		return mapa;
	}

	private Map<String, Integer> returnMapRank(String tipoPonto) {
